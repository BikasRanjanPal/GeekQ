...
public class AccessControlAspectsQuiz {
	...
	@Around("execution(* com.geekq.api.gateway.repository.QuizRepository.save(..)) && args(quiz,..)")
	...
	@Around("execution(* com.geekq.api.gateway.repository.QuizRepository.find(Long)) && args(id)")
	...
	@Around("execution(* com.geekq.api.gateway.repository.QuizRepository.findAll())")
	...
	@Around("execution(* com.geekq.api.gateway.repository.QuizRepository.delete(..)) && args(quiz)")
